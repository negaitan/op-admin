        ...
        <div class="card-body">
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    {{ html()->label(__('backend_plans.validation.attributes.title'))->class('col-md-2 form-control-label')->for('title') }}

                        <div class="col-md-10">
                            {{ html()->text('title')
                                ->class('form-control')
                                ->placeholder(__('backend_plans.validation.attributes.title'))
