        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('backend_class_groups.labels.management') }} <small class="text-muted">{{ __('backend_class_groups.labels.deleted') }}</small>
                </h4>
            </div><!--col-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>@lang('backend_class_groups.table.deleted')</th>
                        ...
                        @foreach($classGroups as $classGroup)
                            <tr>
                                ...
                                <td class="align-middle">{{ $classGroup->deleted_at->diffForHumans() }}</td>
                                <td class="align-middle">{!! $classGroup->trashed_buttons !!}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
