<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/brand/logo.png') }}" width="89" height="25" alt="OpenPark Logo">
        <img class="navbar-brand-minimized" src="{{ asset('img/backend/brand/favicon.png') }}" width="30" height="30" alt="OpenPark Logo">
    </a>
